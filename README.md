...
* [create-npm-package](https://github.com/MatteoGabriele/create-npm-package) like this but w/o: npm package (!), github repo, description, travis & etc. `create-npm-package` react focused also.
